...
![The cerebellum sends its output through the superior cerebellar peduncle (SCP), the contralateral red nucleus (RN), and VA/VL of the thalamus to various cerebral areas… The decussation (d) of the cerebero-thalamo-cortical pathway is indicated by the yellow circle.](images/palesi.jpg){#id .class width=100% height=100% }
...
![a](images/sub-50010_SCP_back.png){#id .class width=100% height=100% }
![b](images/sub-50010_SCP_back.png){#id .class width=100% height=100% }
![c](images/sub-50010_SCP_back.png){#id .class width=100% height=100% }
![d](images/sub-50010_SCP_back.png){#id .class width=100% height=100% }
