...
- Data: the UCLA Consortium for Neuropsychiatric Phenomics LA5c Study (Gorgolewski et al. 2017, Bilder et al. 2020), which includes diffusion MRI (dMRI) data from 49 participants with SZ (mean age: 36.2 +/- 8.8 SD; 12 female) and 123 controls (CTRL) (mean age: 31.6 +/- 8.8 SD; 58 female). 
